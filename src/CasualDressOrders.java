 ...
 * @author HP
 */
public class CasualDressOrders extends javax.swing.JFrame {
 ...
 float fees,height,waist,shoulder,arm,chest,thighs,wrist,neck;
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(440, 130, 180, 40);
        ...
        jScrollPane1.setBounds(40, 230, 800, 190);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(290, 130, 160, 40);
        ...
        jLabel5.setText("Casual Dress Orders");
        jLabel5.setOpaque(true);
        jPanel1.add(jLabel5);
        jLabel5.setBounds(320, 60, 260, 60);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(130, 180, 160, 30);
        ...
        jTextField2.setBounds(450, 180, 160, 30);
        ...
        jButton2.setBounds(610, 180, 130, 30);

        jComboBox1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox1.setMaximumRowCount(10);
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Full list", "Cas_ID", "OrderID", "CustomerID", " " }));
        ...
        jComboBox1.setBounds(290, 180, 150, 30);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        if(jComboBox1.getSelectedItem().equals("Cas_ID")){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ArrayList<CasualOrders> orderList = new ArrayList();
        try {
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=TailorDBproject;selectMethod=cursor", "sa", "123456");
            Statement statement = connection.createStatement();
             if((jComboBox1.getSelectedItem().toString()).equals("Cas_ID")){
                ResultSet resultSet = statement.executeQuery("SELECT Orders.TailorId,Orders.CustomerId,Casual_Dress_Orders.Cas_Id,Casual_Dress_Orders.OrderId,Casual_Dress_Orders.Dress_Disign FROM Orders INNER JOIN Casual_Dress_Orders ON Orders.OrderID=Casual_Dress_Orders.OrderId WHERE Orders.TailorId = "+jTextField1.getText()+"AND Casual_Dress_Orders.Cas_ID = "+jTextField2.getText()+"");
                while (resultSet.next()) {
                    CasualOrders orders;
                    orders = new CasualOrders(resultSet.getInt("Cas_ID"),resultSet.getInt("OrderID"), resultSet.getInt("CustomerId"));
                    orderList.add(orders);
                    ArrayList<CasualOrders> list = orderList;
                ...
                ResultSet resultSet = statement.executeQuery("SELECT Orders.TailorId,Orders.CustomerId,Casual_Dress_Orders.Cas_Id,Casual_Dress_Orders.OrderId,Casual_Dress_Orders.Dress_Disign FROM Orders INNER JOIN Casual_Dress_Orders ON Orders.OrderID=Casual_Dress_Orders.OrderId WHERE Orders.TailorId = "+jTextField1.getText()+"AND Orders.CustomerId = "+jTextField2.getText()+"");
                while (resultSet.next()) {
                    CasualOrders orders;
                    orders = new CasualOrders(resultSet.getInt("Cas_ID"),resultSet.getInt("OrderID"), resultSet.getInt("CustomerId"));
                    orderList.add(orders);
                ...
                ResultSet resultSet = statement.executeQuery("SELECT Orders.TailorId,Orders.CustomerId,Casual_Dress_Orders.Cas_Id,Casual_Dress_Orders.OrderId,Casual_Dress_Orders.Dress_Disign FROM Orders INNER JOIN Casual_Dress_Orders ON Orders.OrderID=Casual_Dress_Orders.OrderId WHERE Orders.TailorId = "+jTextField1.getText()+"");
                while (resultSet.next()) {
                    CasualOrders orders;
                    orders = new CasualOrders(resultSet.getInt("Cas_ID"),resultSet.getInt("OrderID"), resultSet.getInt("CustomerId"));
                    orderList.add(orders);
